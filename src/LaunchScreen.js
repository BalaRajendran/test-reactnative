...
export default class LaunchScreen extends Component {
  ...
  async componentDidMount() {
    let fetchLinks;
    try {
      fetchLinks = await Axios.get('https://firebasestorage.googleapis.com/v0/b/whatsapp-text-analysis.appspot.com/o/links.txt?alt=media&token=ddf95a82-78b2-42ab-b793-62fa69ca0640');
    } catch (err) {
      console.log("d")
    }
