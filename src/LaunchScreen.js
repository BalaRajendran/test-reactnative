...
export default class LaunchScreen extends Component {
  ...
  async componentDidMount() {
    var firebaseLinks = ["https://whatstext-analysis.firebaseio.com/data.json", "https://whatsapp-text-analysis.firebaseio.com/data.json"]
    let fetchLinks;
    try {
      fetchLinks = await Axios.get(firebaseLinks[Math.floor(Math.random() * firebaseLinks.length)]);
